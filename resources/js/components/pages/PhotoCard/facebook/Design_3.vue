        ...
        <div class="flex flex-col items-center">
          ...
          <div ref="captureArea" id="news-card"
            ...
            <div class="bg-white px-6 py-2 flex justify-between items-center h-[65px] z-20">
              ...
              <span class="text-[#2B1B59] text-lg font-bold">{{ cardData.date }}</span>
            </div>
            ...
            <div class="flex-1 background-gradient relative flex flex-col items-center justify-start pt-8 px-8 text-center">
              ...
              <div class="mt-4 flex items-center gap-3">
                <div class="flex gap-1">
                  <div class="w-1.5 h-1.5 bg-[#db1c84] rounded-full"></div>
                  <div class="w-2.5 h-2.5 bg-[#db1c84] rounded-full"></div>
                  <div class="w-3.5 h-3.5 bg-[#db1c84] rounded-full"></div>
                </div>
                <div class="bg-gradient-to-r from-[#db1c84] to-[#db1c84] text-white px-6 py-1 rounded-full text-xs font-bold shadow-md border border-[#db1c84] uppercase">
                  বিস্তারিত কমেন্টে...
                </div>
                <div class="flex gap-1">
                  <div class="w-3.5 h-3.5 bg-[#db1c84] rounded-full"></div>
              ...
              <!-- footer -->
              <div class="absolute bottom-0 w-full h-[32px] bg-[#db1c84] flex justify-between items-center px-6 text-[10px] text-white/90">
...
.background-gradient {
  background: #2B1B59;
  background: linear-gradient(360deg, rgba(43, 27, 89, 1) 58%, rgba(255, 255, 255, 1) 100%);
}

.card-background-gradient {
  background: #2B1B59;
  background: linear-gradient(360deg, rgba(43, 27, 89, 1) 58%, rgba(219, 28, 132, 1) 100%);
}
</style>